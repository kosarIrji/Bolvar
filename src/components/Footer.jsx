...
export default function Footer() {
  ...
  return (
    <div
      className="
        w-full text-white z-10 flex flex-col lg:flex-row justify-between items-center 
        p-4 sm:pl-9 px-5 sm:mt-3 h-auto sm:rounded-2xl 
        bg-black/60 backdrop:blur-3xl bg-opacity-40 shadow-black/20 shadow-lg backdrop-blur-md
